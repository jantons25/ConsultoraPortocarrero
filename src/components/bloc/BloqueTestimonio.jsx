...
function BloqueTestimonio({imagen, colorLetra, colorFondo}) {
  return (
    <div className="bloque__testimonio ">
      ...
      <div className="contenido" style={{color: colorLetra}}>
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veniam numquam provident ex facere est quos in asperiores corrupti omnis quas!</p>
      </div>
